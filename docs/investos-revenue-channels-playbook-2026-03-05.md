...
| 3 | **Nicholas's Network** | Referral network | Personal connections in $20M+ space |
| 4 | **Jason's Network** | Referral network | Personal connections in $20M+ space |
| 5 | **Travis's Network** | Referral network | Personal connections in $20M+ space |
| 6 | **Eyob's Network** | Referral network | Personal connections in $20M+ space |
| 7 | **Will's Network** | Referral network | Personal connections in $20M+ space |
...
**Channels 3-7 (Personal networks)** are the growth engine. Each network partner activates their top 2-3 connections — investors and founders seeking $20M+ in health and wellness optimization, biotech, and regenerative real estate. That's 10-15 warm introductions across 5 networks.

**The math:**
- 5 network partners × 2-3 top connections = 10-15 warm introductions
...
*Smaller raises carry higher effective rates (more work per dollar raised). Larger raises benefit from scale efficiency.*
