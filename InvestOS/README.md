...
flowchart TD
    ...
    style INV fill:#4a3a1a,color:#fff,stroke:#f59e0b,stroke-width:2px
...
flowchart LR
    subgraph D["Discovery"]
        S["Strategy +<br/>Market Research"]
    end
    subgraph L["Legal"]
        E["Entity +<br/>Compliance"]
    end
    subgraph F["Financial"]
        M["Model +<br/>Valuation"]
    end
    subgraph MA["Materials"]
        DR["Data Room +<br/>Platform"]
    end
    subgraph EX["Execution"]
        IR["Readiness<br/>Check"]
    end
    ...
    style MA fill:#1a2a3a,color:#fff
    style EX fill:#2a1a3a,color:#fff
```
